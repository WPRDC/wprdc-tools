...
MODEL_MAPPING = {
    "pittsburgh_neighborhood": {
        "url": "",
        "source": BASE_DIR / "pgh_hood/Pittsburgh_Neighborhoods.shp",
        "model": "PghHood",
        "mapping": {
            "objectid": "objectid",
    ...
    "pittsburgh_fire_zone": {
        "source": BASE_DIR / "pgh_fire_zone/fire_zone.shp",
        "model": "PghFireZone",
        "mapping": {
    ...
    "pittsburgh_police_zone": {
        "source": BASE_DIR / "pgh_police/Pittsburgh_Police_Zones.shp",
        "model": "PghPoliceZone",
        "mapping": {
            "objectid": "objectid",
            "perimeter": "perimeter",
    ...
    "pittsburgh_ward": {
        "source": BASE_DIR / "pgh_ward/wards.shp",
        "model": "PghWard",
        "mapping": {
            "fid": "FID",
            "area": "AREA",
    ...
    "pittsburgh_city_council": {
        "source": BASE_DIR / "pgh_city_council/Pittsburgh_City_Council_Districts.shp",
    ...
    "pittsburgh_dpw_division": {
        "source": BASE_DIR / "pgh_dpw_division/PGH_DPWDivisions.shp",
    ...
    "allegheny_county_municipality": {
        "source": BASE_DIR / "ac_municipalities/Allegheny_County_Municipal_Boundaries.shp",
    ...
    "block_group": {
        "source": BASE_DIR / "block_groups/Allegheny_County_Census_Block_Groups_2016.shp",
        "model": "BlockGroup",
        "mapping": {
            "fid": "FID",
            "state": "STATEFP",
    ...
    "census_tract": {
        "source": BASE_DIR / "census_tracts/Allegheny_County_Census_Tracts_2016.shp",
        "model": "CensusTract",
        "mapping": {
            "geo_id": "GEOID",
            "state": "STATEFP",
    ...
    "census_block": {
        "source": BASE_DIR / "census_blocks/Allegheny_County_Census_Blocks_2016.shp",
        "model": "CensusBlock",
        "mapping": {
            "fid": "FID",
            "state": "STATEFP10",
    ...
    "school_district": {
        "source": BASE_DIR / "school_dist/Allegheny_County_School_District_Boundaries.shp",
    ...
    "parcel": {
        "source": BASE_DIR / "parcels/untitled_table_24.shp",
        "model": "Parcel",
        "mapping": {
            "objectid": "objectid",
            "pin": "pin",
